...
class Body:
    ...
    def write(self):
        ...
        self.pen.write("SHORTEST PATH FINDER BETWEEN 2 BLOCKS", False, align="left", font=("arial", 20, "bold"))
        self.pen.goto(-480, 270)
        self.pen.write("Instructions:", False, align="left", font=("arial", 15, "bold"))
        self.pen.goto(-480, 250)
        self.pen.write(
            "a) Press 's' in the keyboard and click anywhere on grid to place the starting point.(will be in green)"
            , False,align="left", font=("arial", 10, "bold"))
        self.pen.goto(-480, 230)
        self.pen.write("b) Press 'e' in the keyboard and click anywhere on grid to place the ending point."
                       "(will be in blue)",False, align="left", font=("arial", 10, "bold"))
        self.pen.goto(-480, 210)
        self.pen.write("c) Press 'h' in the keyboard and click anywhere on grid to place the hurdles.(will be in red)",
                       False, align="left", font=("arial", 10, "bold"))
        ...
        self.pen.write("e) Press 'space bar' in the keyboard to see the shortest path(will be in black)", False,
